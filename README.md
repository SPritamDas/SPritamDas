...
| 📉 **FaceNet AI**            | **FaceNet AI** is an advanced deep learning solution designed for **demographic analysis** (age, gender, ethinicity) from facial images        | Data Augmentation, Transfer Learning, vgg16, CNN, Functional Modeling          | **72% accuracy** in predictions        | [View Project](https://github.com/SPritamDas/My-Projects/tree/main/Financial/IPO%20Underpricing](https://github.com/SPritamDas/Portfolio-Projects/blob/main/FaceNet%20AI/Description.md) |
