...
| 🤖 **FaceNet AI**                            | Developed a deep learning solution for demographic analysis (age, gender, ethnicity) from facial images. | Data Augmentation, Transfer Learning, VGG16, CNN, Functional Modeling  | 72% accuracy in predictions               | [View Project](https://github.com/SPritamDas/Portfolio-Projects/blob/main/FaceNet%20AI/Description.md)|
