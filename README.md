...
|---------------------------------------------|---------------------------------------------------------------------------------------------|-------------------------------------------|--------------------------------------------|---------------------------------------------------------------------------------------------------|
| 💳 **Loan Approval Prediction**              | Developed a machine learning model using ensemble methods, ANN, and AutoML for loan approval prediction. | Python, scikit-learn, AutoML              | High accuracy in loan approval prediction | [View Project](https://github.com/SPritamDas/Portfolio-Projects/blob/main/Loan%20Approval%20Prediction/Description.md) |
